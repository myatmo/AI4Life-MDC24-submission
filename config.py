...
def addAllArguments(parser):
    ...
    parser.add_argument("--dataRoot", type=str, default="./test/input/images/image-stack-structured-noise/", help="path to dataset root")
    ...
    parser.add_argument("--p", type=float, default=0.4, help="probability of dropout, default=0.4")
    ...
    parser.add_argument("--lambdaIQA", type=float, default=2e-8, help="weight of iqa loss, default=2e-8")
    
    # For inference
    parser.add_argument("--resultsDir", type=str, default="./test/output/images/image-stack-structured-noise/", help="saves testing results here.")
